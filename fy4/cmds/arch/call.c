...
//	if(!me->query("env/FYnocall")) return notify_fail("’‚∏ˆ÷∏¡Ó“—æ≠±ª∑œ≥˝¡À£°\n");
	if( arg ) {
		//-> Added by neon :P	
		...
		if( sscanf(arg, "-%s %s", euid, arg)==2 ) {
			if( (string)SECURITY_D->get_status(me) != "(admin)" )
				return notify_fail("ƒ„≤ªƒ‹…Ë∂®◊‘º∫µƒ euid°£\n");
			seteuid(euid);
		}
		else
		...
		if( sscanf(arg, "%s->%s(%s)", objname, func, param)!=3 )
			return notify_fail("÷∏¡Ó∏Ò Ω£∫call <ŒÔº˛>-><∫Ø ˝>( <≤Œ ˝>, ... )\n");
	} else
		return notify_fail("÷∏¡Ó∏Ò Ω£∫call <ŒÔº˛>-><∫Ø ˝>( <≤Œ ˝>, ... )\n");
	...
	if(!obj) return notify_fail("’“≤ªµΩ÷∏∂®µƒŒÔº˛°£\n");
...
write(@HELP
[0;1;37m©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§[0m
[0;1;36mŒ◊ ¶÷∏¡Ó∏Ò Ω : 	call <ŒÔº˛>-><∫Ø ˝>(<≤Œ ˝>, ...... )[0m
[0;1;37m©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§©§[0m   

∫ÙΩ–<ŒÔº˛>¿Ôµƒ<∫Ø ˝>≤¢¥´»Îœ‡πÿ<≤Œ ˝>£¨
À˘”–CALL∂º”–œ‡πÿºÕ¬º°£
