...
private int refresh_delay = 300;  	//迷宫重建时间, default is 0 means no recreation
private int private_flag = 1;				// Privite Maze? // annie. 09.2003
private string owner;				// private maze owner
private object mark_ob;				// who got the "maze" mark?
/******************* ---- END ---- *********************/
